...
public class UserControllerTest {
    ...
    public void testFindUser() throws Exception {
        ...
        mvc.perform(get("/csw/v1/users/{id}", "a98b8fe5-7cc5-4348-8f99-4860f5b84b13")
                .header("Authorization", "Bearer 5d1103e-b3e1-4ae9-b606-46c9c1bc915a"))
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().is2xxSuccessful())
    ...
    public void testInsertUser() throws Exception {
        ...
        mvc.perform(post("/csw/v1/users/user")
                .header("Authorization", "Bearer 5d1103e-b3e1-4ae9-b606-46c9c1bc915a")
    ...
    public void testDeleteUser() throws Exception {
        ...
        mvc.perform(delete("/csw/v1/users/{id}", "a98b8fe5-7cc5-4348-8f99-4860f5b84b13")
                .header("Authorization", "Bearer 5d1103e-b3e1-4ae9-b606-46c9c1bc915a"))
                .andExpect(status().is2xxSuccessful());
